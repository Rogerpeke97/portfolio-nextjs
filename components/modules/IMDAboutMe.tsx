...
const IMDAboutMe = ({ className="", children }: 
  { className?: string, children?: Array<ReactElement> | ReactElement | string }) => {
  return(
    <div className={`py-24 flex flex-col ${className}`}>
      <IMDAnimatedTextBounce className="text-6xl xs:text-4xl" letterClass="underline" text="About:" />
      <p className="mt-12 text-2xl xs:text-xl">
        {
          `Full-stack software developer, with 2 years of experience. Participated in different projects of
