...
export const PROJECTS: Array<PROJECT> = [
  ...
  {
    preview: {name: "/projects/face-recognition.png", alt: "Face Recognition"},
    title: "Face Recognition",
    description: "A minimalistic face recognition system that uses a neural network to recognize faces.",
    github: [
      {link: "https://github.com/Rogerpeke97/Face-Recognition"}
    ],
  ...
  },
  {
    ...
    title: "Old portfolio",
    description: "This is the old portfolio that I made before I started working on this website.",
    github: [
      {link: "https://github.com/Rogerpeke97/portfolio"}
    ],
